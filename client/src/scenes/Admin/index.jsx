      ...
      >
        ...
        >
          <StatBox
            ...
            icon={
              <EmailIcon
                sx={{ color: colors.palette.primary[600], fontSize: "26px" }}
              />
            }
          />
        </Box>
            ...
            <Box>
              <IconButton>
                <DownloadOutlinedIcon
                  sx={{ fontSize: "26px", color: colors.palette.primary[500] }}
                />
              </IconButton>
            </Box>
          </Box>
        ...
        >
          <Box
            ...
            colors={colors.palette.grey[100]}
            p="15px"
          >
            <Typography color={colors.palette.grey[100]} variant="h5" fontWeight="600">
              Recent Transactions
            </Typography>
          </Box>
